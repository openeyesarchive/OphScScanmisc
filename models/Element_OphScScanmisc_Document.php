...
/**
 * This is the model class for table "et_ophscscanmisc_document".
 *
...
class Element_OphScScanmisc_Document extends ElementScannedDocument
{
	public $service;
	...
	{
		return 'et_ophscscanmisc_document';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('asset_id', 'required', 'message' => "Please select a document to associate with this event"),
